...
public class CapNhatThongTinKhachHangNhanVien extends JFrame implements ActionListener {
	...
	public CapNhatThongTinKhachHangNhanVien() {
		// TODO Auto-generated constructor stub
		this.UICapNhatThongTinKhachHangNhanVien();
	}

	private void UICapNhatThongTinKhachHangNhanVien() {
		setTitle("Quản lý cửa hàng tiện lợi - Cập nhật thông tin khách hàng");
		setSize(1000, 600);
	...
	public static void main(String[] args) {
		new CapNhatThongTinKhachHangNhanVien().setVisible(true);
	}
